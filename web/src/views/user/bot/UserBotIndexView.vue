    ...
    <div class="col-9">
        <div class="card" style="margin-top: 20px;">
            <div class="card-header">
                ...
                <button type="button" class="btn btn-info float-end" data-bs-toggle="modal" data-bs-target="#add-bot-btn">
                    创建Bot
                </button>
                <!-- Modal  创建-->
            ...
            <div class="card-body">
                ...
                <tbody>
                    <tr v-for="bot in bots" :key="bot.id">
                        ...
                        <td>
                            <button type="button" class="btn btn-danger" style="margin-right: 20px;" @click="remove_bot(bot)">删除</button>
                            <button type="button" class="btn btn-warning" data-bs-toggle="modal" :data-bs-target="'#update-bot-modal-'+bot.id">修改</button>
